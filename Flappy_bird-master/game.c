...
char* score_name(){
    ...
    *counter = characters[0];
    ...
    display_string(0,counter);
    display_string(1,"your name");
...
// char* s1;
// s1 = itoconv(score1);
// char* s2= itoconv(score2);
// char* s3= itoconv(score3);
//
//   // display_string(2, itoaconv(score3));
//     display_string(0, combine_strings(name1, s1));
//     display_string(1, combine_strings(name2, s2));
//     display_string(2, combine_strings(name3, s3));
